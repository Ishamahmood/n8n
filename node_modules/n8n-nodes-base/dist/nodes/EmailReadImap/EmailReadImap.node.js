...
class EmailReadImap {
            ...
            credentialTest: {
                async imapConnectionTest(credential) {
                    ...
                    try {
                        ...
                        if (!lodash_1.default.isEmpty(tlsOptions)) {
                            config.imap.tlsOptions = tlsOptions;
                        }
                        const conn = (0, imap_simple_1.connect)(config).then(async (conn) => {
                            return conn;
                        });
    ...
    async trigger() {
        ...
        const returnedPromise = await (0, n8n_workflow_1.createDeferredPromise)();
                ...
                onmail: async () => {
                    if (connection) {
                        ...
                        try {
                            ...
                            n8n_workflow_1.LoggerProxy.error('Email Read Imap node encountered an error fetching new emails', {
                                error,
                            });
