...
class MergeV2 {
    ...
    async execute() {
            ...
            for (entry1 of input1) {
                for (entry2 of input2) {
                    returnData.push({
                        ...
                        binary: {
                            ...(0, lodash_1.merge)({}, entry1.binary, entry2.binary),
                        },
                        pairedItem: [
                            entry1.pairedItem,
                            entry2.pairedItem,
        ...
        if (mode === 'mergeByFields') {
            ...
            const outputDataFrom = this.getNodeParameter('outputDataFrom', 0, '');
            ...
            if (joinMode === 'keepMatches') {
                ...
                if (outputDataFrom === 'both') {
                    ...
                    const mergedEntries = (0, GenericFunctions_1.mergeMatched)(matches.matched, clashResolveOptions);
