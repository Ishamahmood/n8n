import { IBinaryKeyData, IDataObject, INodeExecutionData, IPairedItemData } from 'n8n-workflow';
...
export declare type MatchFieldsJoinMode = 'keepMatches' | 'keepNonMatches' | 'enrichInput2' | 'enrichInput1';
