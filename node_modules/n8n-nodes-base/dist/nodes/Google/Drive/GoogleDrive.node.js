...
class GoogleDrive {
    constructor() {
                ...
                },
                {
                    ...
                    modes: [
                        ...
                        },
                        {
                            ...
                            name: 'url',
                            type: 'string',
                            placeholder: 'https://docs.google.com/spreadsheets/d/1-i6Vx0NN-3333eeeeeeeeee333333333/edit',
                            extractValue: {
                                type: 'regex',
        ...
        this.methods = {
            listSearch: {
                async fileSearch(filter, paginationToken) {
                    const query = [];
                    if (filter) {
                ...
                async folderSearch(filter, paginationToken) {
                    const query = [];
                    if (filter) {
                        query.push(`name contains '${filter.replace("'", "\\'")}'`);
                    }
                ...
                async driveSearch(filter, paginationToken) {
            ...
            try {
                ...
                if (resource === 'file') {
                    if (operation === 'copy') {
                        ...
                        const file = await GenericFunctions_1.googleApiRequest.call(this, 'GET', `/drive/v3/files/${fileId}`, {}, { fields: 'mimeType', supportsTeamDrives: true });
                        let response;
                        ...
                        let response = await GenericFunctions_1.googleApiRequest.call(this, 'POST', `/upload/drive/v3/files`, body, qs, undefined, requestOptions);
                        body = {
                            mimeType,
                            name,
                            originalFilename,
                        ...
                        response = await GenericFunctions_1.googleApiRequest.call(this, 'PATCH', `/drive/v3/files/${JSON.parse(response).id}`, body, qs);
                        if (resolveData === true) {
