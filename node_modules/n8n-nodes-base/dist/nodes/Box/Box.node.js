                    ...
                    if (operation === 'search') {
                        ...
                        if (additionalFields.createdRangeUi) {
                            ...
                            if (createdRangeValues) {
                                qs.created_at_range = `${moment_timezone_1.default
                                    .tz(createdRangeValues.from, timezone)
                                    .format()},${moment_timezone_1.default.tz(createdRangeValues.to, timezone).format()}`;
                            }
                        ...
                        if (additionalFields.updatedRangeUi) {
                            ...
                            if (updateRangeValues) {
                                qs.updated_at_range = `${moment_timezone_1.default
                                    .tz(updateRangeValues.from, timezone)
                                    .format()},${moment_timezone_1.default.tz(updateRangeValues.to, timezone).format()}`;
                            }
