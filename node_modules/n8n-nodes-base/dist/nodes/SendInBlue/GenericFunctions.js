...
(function (SendInBlueNode) {
    ...
    SendInBlueNode.INTERCEPTORS = new Map([
        [
    ...
    (function (Validators) {
        async function validateAndCompileAttachmentsData(requestOptions) {
            ...
            try {
                ...
                for (const attachmentDataName of dataMappingList) {
                    ...
                    const bufferFromIncomingData = (await this.helpers.getBinaryDataBuffer(binaryPropertyName));
                    const { data: content, mimeType, fileName, fileExtension, } = await this.helpers.prepareBinaryData(bufferFromIncomingData);
                    const itemIndex = this.getItemIndex();
                    const name = getFileName(itemIndex, mimeType, fileExtension, fileName || item.binary.data.fileName);
        ...
        async function validateAndCompileTemplateParameters(requestOptions) {
            ...
            const { body } = requestOptions;
            const { parmeters } = parameterData;
            const params = parmeters
                .split(',')
                .filter((parameter) => {
    ...
    })(Validators = SendInBlueNode.Validators || (SendInBlueNode.Validators = {}));
...
})(SendInBlueNode = exports.SendInBlueNode || (exports.SendInBlueNode = {}));
var SendInBlueWebhookApi;
(function (SendInBlueWebhookApi) {
    const credentialsName = 'sendinblueApi';
    const baseURL = 'https://api.sendinblue.com/v3';
    SendInBlueWebhookApi.supportedAuthMap = new Map([
        [
            'apiKey',
            async (ref) => {
    ...
    SendInBlueWebhookApi.fetchWebhooks = async (ref, type) => {
    ...
    SendInBlueWebhookApi.createWebHook = async (ref, type, events, url) => {
        ...
        return JSON.parse(webhookId);
    };
    SendInBlueWebhookApi.deleteWebhook = async (ref, webhookId) => {
...
})(SendInBlueWebhookApi = exports.SendInBlueWebhookApi || (exports.SendInBlueWebhookApi = {}));
