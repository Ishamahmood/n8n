            ...
            try {
                if (resource === 'client') {
                    ...
                    if (operation === 'get') {
                        ...
                        let response;
                        response = await GenericFunctions_1.haloPSAApiRequest.call(this, 'GET', `/client/${clientId}`, tokens.access_token);
                ...
                if (resource === 'site') {
                    ...
                    if (operation === 'get') {
                        ...
                        const simplify = this.getNodeParameter('simplify', i);
                        let response;
                        response = await GenericFunctions_1.haloPSAApiRequest.call(this, 'GET', `/site/${siteId}`, tokens.access_token);
                        responseData = simplify
                            ? (0, GenericFunctions_1.simplifyHaloPSAGetOutput)([response], simplifiedOutput)
                            : response;
                    }
                ...
                if (resource === 'ticket') {
                    ...
                    if (operation === 'get') {
                        ...
                        const simplify = this.getNodeParameter('simplify', i);
                        let response;
                        response = await GenericFunctions_1.haloPSAApiRequest.call(this, 'GET', `/tickets/${ticketId}`, tokens.access_token);
                        responseData = simplify
                            ? (0, GenericFunctions_1.simplifyHaloPSAGetOutput)([response], simplifiedOutput)
                            : response;
                    }
                ...
                if (resource === 'user') {
                    ...
                    if (operation === 'get') {
                        ...
                        const simplify = this.getNodeParameter('simplify', i);
                        let response;
                        response = await GenericFunctions_1.haloPSAApiRequest.call(this, 'GET', `/users/${userId}`, tokens.access_token);
                        responseData = simplify
                            ? (0, GenericFunctions_1.simplifyHaloPSAGetOutput)([response], simplifiedOutput)
                            : response;
                    }
