        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    const data = await GenericFunctions_1.calApiRequest.call(this, 'GET', '/hooks', {});
                ...
                async create() {
                    ...
                    const responseData = await GenericFunctions_1.calApiRequest.call(this, 'POST', '/hooks', body);
