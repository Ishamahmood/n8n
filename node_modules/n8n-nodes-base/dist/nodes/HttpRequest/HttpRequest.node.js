...
class HttpRequest {
    ...
    async execute() {
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            const isBatchingEnabled = options.batchSize >= 0 && options.batchInterval > 0;
                        ...
                        if (sendBinaryData === true) {
                            ...
                            if (options.bodyContentType === 'raw') {
                                ...
                                if (item.binary[binaryPropertyName] === undefined) {
                                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), `No binary data property "${binaryPropertyName}" does not exists on item!`, { itemIndex });
                                }
