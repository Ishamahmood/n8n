...
class QuestDb {
    ...
    async execute() {
        ...
        if (operation === 'executeQuery') {
            ...
            const queryResult = await (0, Postgres_node_functions_1.pgQuery)(this.getNodeParameter, pgp, db, items, this.continueOnFail(), mode);
            returnItems = this.helpers.returnJsonArray(queryResult);
        }
        else if (operation === 'insert') {
            await (0, Postgres_node_functions_1.pgInsert)(this.getNodeParameter, pgp, db, items, this.continueOnFail(), 'independently');
