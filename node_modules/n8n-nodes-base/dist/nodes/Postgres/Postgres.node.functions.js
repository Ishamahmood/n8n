...
exports.pgUpdateV2 = exports.pgUpdate = exports.pgInsertV2 = exports.pgInsert = exports.pgQueryV2 = exports.pgQuery = exports.generateReturning = exports.getItemCopy = exports.getItemsCopy = void 0;
        ...
        return db.tx(async (t) => {
            ...
            for (let i = 0; i < allQueries.length; i++) {
                try {
                    ...
                    const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(transactionResult), { itemData: { item: i } });
        ...
        return db.tx(async (t) => {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                try {
                    ...
                    result.push(...this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(insertResult), {
                        itemData: { item: i },
                    }));
                }
                catch (err) {
        ...
        return db.task(async (t) => {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                try {
                    const insertResult = await t.oneOrNone(pgp.helpers.insert(itemCopy, cs) + returning);
                    if (insertResult !== null) {
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(insertResult), { itemData: { item: i } });
                        result.push(...executionData);
                    }
                }
                catch (err) {
            ...
            return db.task(async (t) => {
                ...
                for (let i = 0; i < items.length; i++) {
                    ...
                    try {
                        ...
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(independentResult), { itemData: { item: i } });
                        result.push(...executionData);
                    }
                    catch (err) {
                        if (continueOnFail === false)
