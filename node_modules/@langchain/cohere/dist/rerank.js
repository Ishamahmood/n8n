...
export class CohereRerank extends BaseDocumentCompressor {
    constructor(fields) {
        ...
        if (!this.model) {
            throw new Error("Model not specified for CohereRerank instance. Please provide a model name from the options here: https://docs.cohere.com/reference/rerank");
        }
