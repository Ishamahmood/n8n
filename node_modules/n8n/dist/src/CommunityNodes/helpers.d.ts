...
export declare const parseNpmPackageName: (rawString?: string | undefined) => CommunityPackages.ParsedPackageName;
export declare const sanitizeNpmPackageName: (rawString?: string | undefined) => CommunityPackages.ParsedPackageName;
export declare const executeCommand: (command: string, options?: {
    doNotHandleError?: boolean | undefined;
...
export declare const loadClassInIsolation: (filePath: string, className: string) => any;
