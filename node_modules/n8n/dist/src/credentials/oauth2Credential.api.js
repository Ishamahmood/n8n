...
exports.oauth2CredentialController.get('/auth', __1.ResponseHelper.send(async (req) => {
    ...
    if ((0, lodash_get_1.default)(oauthCredentials, 'scope').includes(',')) {
        ...
        data.scope = (0, lodash_get_1.default)(oauthCredentials, 'scope');
        returnUri = `${(0, lodash_get_1.default)(oauthCredentials, 'authUrl', '')}?${querystring_1.default.stringify(data)}`;
    }
