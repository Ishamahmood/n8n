...
export declare type IPushData = PushDataExecutionFinished | PushDataExecutionStarted | PushDataExecuteAfter | PushDataExecuteBefore | PushDataConsoleMessage | PushDataReloadNodeType | PushDataRemoveNodeType | PushDataTestWebhook;
...
declare type PushDataReloadNodeType = {
    data: IPushDataReloadNodeType;
    type: 'reloadNodeType';
};
declare type PushDataRemoveNodeType = {
...
export declare type WhereClause = Record<string, {
    id: string;
}>;
