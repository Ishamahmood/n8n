...
class WorkflowRunnerProcess {
    ...
    async runWorkflow(inputData) {
        ...
        for (const nodeTypeName of Object.keys(this.data.nodeTypeData)) {
            ...
            try {
                tempNode = (0, helpers_1.loadClassInIsolation)(sourcePath, className);
            }
            catch (error) {
        ...
        for (const credentialTypeName of Object.keys(this.data.credentialsTypeData)) {
            ...
            try {
                tempCredential = (0, helpers_1.loadClassInIsolation)(sourcePath, className);
            }
            catch (error) {
        ...
        const { cli } = await _1.GenericHelpers.getVersions();
        ...
        try {
            await (0, UserManagementHelper_1.checkPermissionsForExecution)(this.workflow, userId);
        }
        catch (error) {
        ...
        const additionalData = await _1.WorkflowExecuteAdditionalData.getBase(userId, undefined, workflowTimeout <= 0 ? undefined : Date.now() + workflowTimeout * 1000);
        ...
        additionalData.executeWorkflow = async (workflowInfo, additionalData, options) => {
            const workflowData = await _1.WorkflowExecuteAdditionalData.getWorkflowData(workflowInfo, userId, options === null || options === void 0 ? void 0 : options.parentWorkflowId, options === null || options === void 0 ? void 0 : options.parentWorkflowSettings);
            const runData = await _1.WorkflowExecuteAdditionalData.getRunData(workflowData, additionalData.userId, options === null || options === void 0 ? void 0 : options.inputData);
        ...
        if (this.data.runData === undefined ||
            ...
            let startNode;
            if (((_b = this.data.startNodes) === null || _b === void 0 ? void 0 : _b.length) === 1 &&
                Object.keys((_c = this.data.pinData) !== null && _c !== void 0 ? _c : {}).includes(this.data.startNodes[0])) {
                startNode = (_d = this.workflow.getNode(this.data.startNodes[0])) !== null && _d !== void 0 ? _d : undefined;
            }
