...
const helpers_1 = require("./credentials/helpers");
...
class App {
    ...
    getSettingsForFrontend() {
        ...
        Object.assign(this.frontendSettings.enterprise, {
            sharing: (0, helpers_1.isCredentialsSharingEnabled)(),
        });
    ...
    async config() {
        ...
        this.app.get(`/${this.restEndpoint}/node-translation-headers`, _1.ResponseHelper.send(async (req, res) => {
            ...
            try {
                await fs_1.promises.access(`${headersPath}.js`);
            }
            catch (_) {
                return;
            }
        ...
        if (!config_1.default.getEnv('endpoints.disableUi')) {
            ...
            readIndexFile = readIndexFile.replace(firstLinkedScriptSegment, scriptsString + firstLinkedScriptSegment);
