...
let TestDefinition = class TestDefinition extends abstract_entity_1.WithTimestamps {
};
...
__decorate([
    ...
    (0, class_validator_1.Length)(1, 255, { message: 'Test name must be $constraint1 to $constraint2 characters long.' }),
...
__decorate([
    (0, typeorm_1.OneToOne)('AnnotationTagEntity', 'test'),
