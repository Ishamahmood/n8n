...
let PruningService = class PruningService {
    constructor(logger, instanceSettings, executionRepository, binaryDataService, orchestrationService, pruningConfig) {
        this.logger = logger;
        ...
        this.rates = {
            softDeletion: this.pruningConfig.softDeleteInterval * constants_1.Time.minutes.toMilliseconds,
            hardDeletion: this.pruningConfig.hardDeleteInterval * constants_1.Time.minutes.toMilliseconds,
        };
        this.batchSize = 100;
    ...
    get isEnabled() {
        return (this.pruningConfig.isEnabled &&
