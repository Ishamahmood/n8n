...
let TaskRunnerServer = class TaskRunnerServer {
    ...
    constructor(logger, globalConfig, taskRunnerAuthController, taskRunnerService) {
        this.logger = logger;
    ...
    configureRoutes() {
        this.app.use(this.upgradeEndpoint, this.taskRunnerAuthController.authMiddleware, (req, res) => this.taskRunnerService.handleRequest(req, res));
...
], TaskRunnerServer.prototype, "stop", null);
