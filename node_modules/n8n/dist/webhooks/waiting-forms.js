...
let WaitingForms = class WaitingForms extends waiting_webhooks_1.WaitingWebhooks {
    ...
    async executeWebhook(req, res) {
        ...
        if (execution.finished) {
            ...
            const parentNodes = workflow.getParentNodes(execution.data.resultData.lastNodeExecuted);
            ...
            if (!lastNode.disabled &&
                ...
                completionPage = Object.keys(workflow.nodes).find((nodeName) => {
                    ...
                    return (parentNodes.includes(nodeName) &&
                        !node.disabled &&
        ...
        const targetNode = completionPage || execution.data.resultData.lastNodeExecuted;
