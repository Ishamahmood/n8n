...
const packageModel_1 = require("../src/CommunityNodes/packageModel");
    ...
    async run() {
        ...
        await (async () => {
            try {
                ...
                const databaseSettings = await src_1.Db.collections.Settings.find({ loadOnStartup: true });
                    ...
                    if (flags.reinstallMissingPackages || process.env.N8N_REINSTALL_MISSING_PACKAGES) {
                        ...
                        try {
                            for (const missingPackage of missingPackages) {
                                void (await loadNodesAndCredentials.loadNpmModule(missingPackage.packageName, missingPackage.version));
