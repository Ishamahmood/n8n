const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-Dflnt8gK.js","assets/index-7YFQEQmt.js","assets/index-BFH_KxyA.css","assets/RunDataJsonActions-zNKrn8z4.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ap as useNDVStore, r as ref, jn as nonExistingJsonPath, jo as useElementSize, p as computed, e9 as executionDataToJson, c as openBlock, h as createElementBlock, e as createBlock, w as withCtx, A as unref, f as createCommentVNode, aT as Suspense, i as createVNode, jj as MappingPill, jk as TextWithHighlights, n as normalizeClass, dT as Draggable, bd as defineAsyncComponent, en as __vitePreload, s as shorten, jm as getMappedExpression, eR as isString, aG as useExternalHooks, ak as useTelemetry, _ as _export_sfc } from "./index-7YFQEQmt.js";
import { V as VueJsonPretty } from "./NodeViewSwitcher-B9JUn3eY.js";
import "./RunDataAi-BKu1beM6.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-Dflnt8gK.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
