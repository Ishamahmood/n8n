import { d as defineComponent, bP as mergeModels, cz as useModel, r as ref, p as computed, c as openBlock, e as createBlock, w as withCtx, i as createVNode, k as createTextVNode, t as toDisplayString, A as unref, I as withModifiers, j as createBaseVNode, h as createElementBlock, iL as ProjectSharing, n as normalizeClass, f as createCommentVNode, g as useI18n, l as resolveComponent, _ as _export_sfc, a5 as usePageRedirectionHelper, u as useUsersStore, a1 as useProjectsStore, j3 as useRolesStore, az as useCloudPlanStore, a as useToast, b as useRouter, a3 as useDocumentTitle, H as watch, ar as onBeforeMount, o as onMounted, j4 as N8nFormInput, F as Fragment, z as renderList, V as VIEWS, dK as deepCopy, x as nextTick, dF as ProjectTypes, ak as useTelemetry } from "./index-7YFQEQmt.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onConfirmDelete = async (transferId) => {
      ...
      try {
        if (projectsStore.currentProject) {
          const projectName2 = ((_a = projectsStore.currentProject) == null ? void 0 : _a.name) ?? "";
